...
impl ComputedValuesExt for ComputedValues {
    ...
    fn content_box_size_for_box_size(
        ...
        match self.get_position().box_sizing {
            ...
            BoxSizing::BorderBox => box_size.map_inline_and_block_axes(
                |size| size.map(|value| value - pbm.padding_border_sums.inline),
                |size| size.map(|value| value - pbm.padding_border_sums.block),
            ),
        }
    }
    ...
    fn content_min_box_size(
        ...
        let min_size = self
            ...
            .map_inline_and_block_axes(
                |size| size.map(|lp| lp.to_used_value(containing_block.inline_size)),
                |size| {
                    size.map(|lp| lp.to_used_value(containing_block.block_size.auto_is(Au::zero)))
                },
            );
    ...
    fn content_min_box_size_for_min_size(
        ...
        match self.get_position().box_sizing {
            ...
            BoxSizing::BorderBox => min_box_size.map_inline_and_block_axes(
                |size| size.map(|value| (value - pbm.padding_border_sums.inline).max(Au::zero())),
                |size| size.map(|value| (value - pbm.padding_border_sums.block).max(Au::zero())),
            ),
        }
    }
    ...
    fn content_max_box_size_for_max_size(
        ...
        match self.get_position().box_sizing {
            ...
            BoxSizing::BorderBox => max_box_size.map_inline_and_block_axes(
                |size| size.map(|value| value - pbm.padding_border_sums.inline),
                |size| size.map(|value| value - pbm.padding_border_sums.block),
            ),
        }
